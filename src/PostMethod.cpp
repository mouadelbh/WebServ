...
/*   Updated: 2025/06/28 14:43:57 by mel-bouh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Response::uploadRawFile(Request &request) {
...
void	Response::uploadUrlEncoded(Request &request) {
...
void	Response::executePostBody(Request &request) {
	if (request.headers["Content-Type"] == "application/x-www-form-urlencoded")
		uploadUrlEncoded(request);
	else if (request.headers["Content-Type"] == "multipart/form-data")
		uploadMultiForm(request);
	else
		uploadRawFile(request);
}
